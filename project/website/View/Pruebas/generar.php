...
<p>Aquí podrá generar un documento con un conjunto de preguntas para realizar en papel. Se considerarán todas las preguntas y pruebas, públicas y privadas para generar el PDF.</p>
<?php
...
echo $f->end('Generar documento con la evaluación');
