...
class Model_Pruebas extends \Model_Plural_App
{
    ...
    public function getByUser($id)
    {
        return $this->db->getTable('
            SELECT p.id, c.categoria, p.prueba, p.descripcion
    ...
    public function getDatos($id)
    {
        ...
        return $this->db->getTable('
            SELECT
                usuario.nombre,
                alumnoporpregunta.id_pregunta_relacionada,
                alumnoporpregunta.puntos
            FROM alumnoporpregunta, usuario
            WHERE
                alumnoporpregunta.id_prueba_relacionada = :prueba
        ', [':prueba'=>$id]);
    }
